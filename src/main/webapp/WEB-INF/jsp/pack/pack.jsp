...
$(document).ready(function(){
	$(function(){
		...
		$("#closeButton").click(function(){
			if (confirm("確定要退出嗎?")) {
				window.location.href='<c:url value="/pack/selectPlan.html"/>';
			}
...
<input name="orderId" type="hidden" value="${order.orderId}">
		...
		<table border="1">
				<caption>${order.route.routeName} <input type="button" value="退出包裝" id="closeButton" style="margin-left: 20px;"/></caption>
				 <tr>
					<th>包裝工單</th>
					<th>包装類型</th>
					<th>工單數量</th>
