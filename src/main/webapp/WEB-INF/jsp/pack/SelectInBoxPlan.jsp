		...
		<div class="main">
			...
			<div id="mainbody">
				<form id="orderForm" method="post"
					action="<c:url value="/pack/selectPlan.html"/>">
					<%-- <input type="hidden" value="${currentTime}" id="currentTime"> --%>
					<input type="hidden" name="type" value="small">
					<table border="1" style="width: 400px;">
						<caption>入箱工單填寫${site }</caption>
						
						<tr>
							<td colspan="2">工單號：<input type="text" required="required" name="orderId" id="orderId" data-reg="^S[PRK]1[3-9]\d{2}PB\d{1}$"></td>
						</tr>
						<tr>
			...
			<table border="1" id="orderTable">
					...
					<c:forEach items="${orders}" var="order" varStatus="i">
						<tr align="center">
							...
							<td>
								<a href='<c:url value="/pack/selectPlan.html?orderId=${order.orderId}&&type=small"/>'>${order.orderId}</a>
							</td>
