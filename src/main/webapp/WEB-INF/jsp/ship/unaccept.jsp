...
<title>${modelName} 倉庫退庫</title>
<script type="text/javascript">
	function goBack(palletId){
		if(confirm("確定要退回制造嗎?")){
			location.href='<c:url value="/ship/unaccept.html?palletId='+palletId+'"/>';
		}
	}
</script>
</head>
	...
	<div class="main">
		...
		<div id="mainbody">
			<form name="form1" method="post"
				action="<c:url value="/ship/toUnaccept.html"/>">
				<table>
					<caption>倉庫退回</caption>
					<tr>
						<td>請輸入栈板号:</td>
			...
			<c:if test="${!empty goodses}">
				...
				<div style="margin: 10px 10px; text-align: center;">
					<input style="color: black;" type="button" value="退回制造"
